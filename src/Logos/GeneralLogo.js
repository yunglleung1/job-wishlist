...
const GeneralLogo = () => {
  return(
    <svg
      ...
      className='general'
    >
      <line className="gen-line1" x1='176' y1='416' x2='176' y2='480'/>
      <path className="gen-path1" d='M80,32H272a32,32,0,0,1,32,32V476a4,4,0,0,1-4,4H48a0,0,0,0,1,0,0V64A32,32,0,0,1,80,32Z'/>
      <path className="gen-path2" d='M320,192H432a32,32,0,0,1,32,32V480a0,0,0,0,1,0,0H304a0,0,0,0,1,0,0V208A16,16,0,0,1,320,192Z' />
